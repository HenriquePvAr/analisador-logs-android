...
bashgit clone https://github.com/seu-usuario/analisador-logs.git
cd analisador-logs
...
bashgit clone https://github.com/HenriquePvAr/analisador-logs-android.git
cd analisador-logs
